...
def main():
    ...
    with tab4:
        ...
        # 현재 날짜를 기준일자로 설정 (문자열 형식)
        st.session_state['base_date'] = datetime.now().strftime("%Y-%m-%d")
        ...
        try:
            ...
            if {'date','팀명','BT_1위확률'}.issubset(df_day.columns):
                ...
                try:
                    ...
                    pass
                try:
                    fig_bt1.update_traces(marker=dict(size=10))
                except Exception:
                    pass
            ...
            if {'date','팀명','BT_1-5위확률'}.issubset(df_day.columns):
                ...
                try:
                    ...
                    pass
                try:
                    fig_bt5.update_traces(marker=dict(size=10))
                except Exception:
                    pass
            ...
            if {'date','팀명','매직넘버'}.issubset(df_day.columns):
                ...
                try:
                    ...
                    pass
                fig_magic.update_yaxes(range=[0, 18], dtick=1)  # 매직넘버는 0-18 범위, 1간격 격자
                # 동적 날짜 범위 설정
                if date_range_magic:
